...
在[Agent的评估-04：利用MeaiEvaluatorAdapter适配MEAI评估系统](https://blog.csdn.net/JaydenAI/article/details/163353459)中，我们对MAF的Agent评估系统利用MeaiEvaluatorAdapter适配MEAI评估系统的实现原理进行了详细介绍，但是在[Agent的评估-05:MEAI用来评估LLM响应质量的9种评估器](https://blog.csdn.net/JaydenAI/article/details/163353459)我们却说这种适配方案不够好。那么究竟问题在哪里？又该如何解决呢？
